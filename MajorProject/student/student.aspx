<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student.aspx.cs" Inherits="MajorProject.student.student" %>
    ...
    #fs{
     ...
     #mdv{
          margin-left:19.55%;
           margin-top:-760px; 
           margin-right:-.5%;
           height:755px;     background-color: #e8e6e7;
     }
...
<body>
  ...
  <a class="active" href="#"><i class="fa fa-fw fa-home"></i>Home</a><br />
  <a href="../shared/history.aspx?q=normal" target="_self"><i class="fa fa-fw fa-history"></i> History</a>
  <a href="../shared/Logout.aspx" onclick="return confirm('Are you sure?')" ><i class="fa fa-fw fa-user"></i> Logout</a>
    ...
    <div class="container">
         ...
         <tr><td></td><td style="align-content:end">       <asp:Button SkinID="sk1" Width="300px" ID="btn" runat="server" OnClick="GeneratePass" Text="Create GatePass"/></td></tr>
