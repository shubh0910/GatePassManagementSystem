<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="History.aspx.cs" Inherits="MajorProject.classcounsellor.History" %>
...
<body>
  ...
  <a href="history.aspx?q=approvepassstudent"  id="approvepassstudent" runat="server"><i class="fa fa-fw fa-confirm"></i> Approve Student Gatepass</a>
  <a href="history.aspx?q=approvepassprofessor"  id="approvepassprofessor" runat="server"><i class="fa fa-fw fa-approve"></i> Approve Professor Gatepass</a>
  <a href="history.aspx?q=student" id="student" runat="server" ><i class="fa fa-fw fa-history"></i>Student Gatepass History </a>
  <a href="history.aspx?q=professor" id="professor" runat="server" ><i class="fa fa-fw fa-history"></i>Professor Gatepass History </a>
  <a href="../headofdepartment/updateData.aspx?q=updatestudent" id="updatestudent" runat="server"><i class="fa fa-fw fa-envelope"></i>Update Student</a>
...
<td><asp:Label runat="server" ID="groupbylbl" Text="group by"></asp:Label><asp:DropDownList  AutoPostBack="true"  ID="obddl" runat="server" ></asp:DropDownList>  
</td>
<td>                    <asp:Button ID="btn"  OnClick="clearSelections" Text="Clear Selections" runat="server"/>
                 ...
                 <asp:GridView  Width="100%"  OnPageIndexChanging="GridView1_PageIndexChanging"  PagerSettings-PageButtonCount="50" ID="gv" AllowPaging="true" PageSize="25" PagerSettings-Mode="Numeric"  RowStyle-BackColor="Teal" HeaderStyle-Font-Bold="false" PagerStyle-BackColor="Yellow" PagerStyle-Font-Size="Medium" HeaderStyle-ForeColor="Black" HeaderStyle-Font-Size="Medium" HeaderStyle-BackColor="SlateBlue" HeaderStyle-BorderWidth="3px"  RowStyle-BorderWidth="2px" RowStyle-ForeColor="black"  RowStyle-Font-Size="Medium" AutoGenerateColumns="true" runat="server">
                   ...
                   <HeaderTemplate  >
                       <asp:CheckBox runat="server" ID="CheckBox1"  onclick="CheckAll(this);" /> 
                   </HeaderTemplate> 
                    <ItemTemplate>  
    ...
    </asp:GridView>                          <asp:Button ID="approve1" Text="Approve"  runat="server" onclick="approvepass1" />
