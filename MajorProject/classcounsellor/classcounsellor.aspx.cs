...
{
    public partial class classcounsellor : System.Web.UI.Page
    {
        ...
        {
            if (Request["Username"] == null||Request.Cookies["Username"].Value == "" || Request.Cookies["Username"].Value.Length != 16|| Request.Cookies["Accesstype"].Value != "c")
            {
            ...
            else if (ddr.SelectedIndex > 0)
            {
                ...
                else
                {
                    ...
                    if (DateTime.Now.Hour > 9 && DateTime.Now.Hour < 16)
                    {
                        ...
                        if (Request.Cookies["ccg"].Value.ToString() == "1")
                        {
                            try
                            {
                                ...
                                Response.Redirect("classcounsellor.aspx");
                            }
                            catch (Exception) { }
                        }
                        else
